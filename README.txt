...
The simulations were completed using a computer server with 60 CPU cores. The estimated runtime is approximately 20-30 hours. The small example is expected to complete in approximately 1-2 hours.
